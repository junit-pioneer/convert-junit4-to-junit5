This is a project @boyarsky wrote to [facilitate convert a good number of tests to JUnit 5 syntax](https://www.selikoff.net/?p=7915&preview=true).
...
* Conversion off JUnit 3.8. This program assumes you are on JUnit 4.
  ...
  But the goal of this program is to convert JUnit 4 syntax to JUnit 5 syntax.
...
Then make manual edits at end (or rollback those test classes and deal with them later).
...
This program is also available as a shaded jar.
To use it, run the following command (be aware of correct version depending of the JAR you use!)
java -jar convert-junit4-to-to-junit5-0.1.0.jar /my/dir/src/test/java
